...
[![GitHub: poly-core](https://img.shields.io/badge/GitHub-poly--core-181717?logo=github)](https://github.com/Yrrrrrf/poly-core/tree/main/src/poly-core-macros)
...
Depended on only by [`polyglot-core`](../core) — not meant to be pulled in directly by anything else.

## Overview

`poly-core-macros` is responsible for:
