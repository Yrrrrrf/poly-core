...
[![GitHub: poly-core](https://img.shields.io/badge/GitHub-poly--core-181717?logo=github)](https://github.com/Yrrrrrf/poly-core/tree/main/src/core)
...
* No dependency on any face crate (`poly-core`, and later `poly-core/cli`, `poly-core/wasm`, `poly-core/python`, `poly-core/go`).
